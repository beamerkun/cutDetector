  ...
  public:
	...
	class Observer {
	  public:
		...
		virtual void OnDifferenceCalculated(Frame& last, Frame& first, double difference) = 0;
	}; // SceneDetector::Observer

	virtual sceneList detectScenes(VideoReader* videoReader, FrameComparator* frameComparator) = 0;
